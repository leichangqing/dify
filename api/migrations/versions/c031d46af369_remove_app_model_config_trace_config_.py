...
def downgrade():
    ...
    sa.Column('id', sa.String(36), server_default=sa.text('\'UUID()\''), autoincrement=False, nullable=False),
    sa.Column('app_id', sa.String(36), autoincrement=False, nullable=False),
    sa.Column('tracing_provider', sa.String(length=255), autoincrement=False, nullable=True),
    sa.Column('tracing_config', sa.JSON(), autoincrement=False, nullable=True),
