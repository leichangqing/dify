...
def upgrade():
    ...
    sa.Column('app_model_config_id', sa.String(36), nullable=True),
    ...
    sa.Column('id', sa.String(36), server_default=sa.text('\'UUID()\''), nullable=False),
    sa.Column('app_id', sa.String(36), nullable=False),
    sa.Column('app_model_config_id', sa.String(36), nullable=False),
    ...
    sa.Column('from_end_user_id', sa.String(36), nullable=True),
    sa.Column('from_account_id', sa.String(36), nullable=True),
    sa.Column('read_at', sa.DateTime(), nullable=True),
    sa.Column('read_account_id', sa.String(36), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('source_app_id', sa.String(36), nullable=True),
    ...
    sa.Column('disabled_by', sa.String(36), nullable=True),
    ...
    sa.Column('dataset_process_rule_id', sa.String(36), nullable=True),
    sa.Column('batch', sa.String(length=255), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('created_from', sa.String(length=255), nullable=False),
    sa.Column('created_by', sa.String(36), nullable=False),
    sa.Column('created_api_request_id', sa.String(36), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('tenant_id', sa.String(36), nullable=False),
    sa.Column('app_id', sa.String(36), nullable=False),
    sa.Column('app_owner_tenant_id', sa.String(36), nullable=False),
    sa.Column('position', sa.Integer(), nullable=False),
    ...
    sa.Column('used_by_tenant_id', sa.String(36), nullable=True),
    sa.Column('used_by_account_id', sa.String(36), nullable=True),
    ...
    sa.Column('message_chain_id', sa.String(36), nullable=False),
    sa.Column('position', sa.Integer(), nullable=False),
