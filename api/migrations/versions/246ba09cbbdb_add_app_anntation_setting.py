...
def upgrade():
    ...
    sa.Column('collection_binding_id', sa.String(36), nullable=False),
    sa.Column('created_user_id',  sa.String(36), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'), nullable=False),
    sa.Column('updated_user_id',  sa.String(36), nullable=False),
